// ======================================================================
// boost.v generated from TopDesign.cysch
// 09/17/2016 at 01:21
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1200000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=25, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DAC, CY_INSTANCE_SHORT_NAME=DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DAC, )
...
// Component: clock24_intl
`ifdef CY_BLK_DIR
`undef CY_BLK_DIR
`endif

`ifdef WARP
`define CY_BLK_DIR "C:\Users\suzukihajime\Documents\PSoC Creator\boost\boost.cydsn\clock24_intl"
`include "C:\Users\suzukihajime\Documents\PSoC Creator\boost\boost.cydsn\clock24_intl\clock24_intl.v"
`else
`define CY_BLK_DIR "C:\Users\suzukihajime\Documents\PSoC Creator\boost\boost.cydsn\clock24_intl"
`include "C:\Users\suzukihajime\Documents\PSoC Creator\boost\boost.cydsn\clock24_intl\clock24_intl.v"
`endif
...
// clock24(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=clock24, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=clock, CY_INSTANCE_SHORT_NAME=clock, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=clock, )
module clock24_3 (
    up,
    down,
    mode,
    ...
    CyControlReg_v1_80 creg (
        ...
        .reset(1'b0),
        .control_bus(seg[7:0]));
    defparam creg.Bit0Mode = 0;
    defparam creg.Bit1Mode = 0;
    defparam creg.Bit2Mode = 0;
    defparam creg.Bit3Mode = 0;
    defparam creg.Bit4Mode = 0;
    defparam creg.Bit5Mode = 0;
    defparam creg.Bit6Mode = 0;
    defparam creg.Bit7Mode = 0;
    defparam creg.BitValue = 0;
    defparam creg.BusDisplay = 1;
    defparam creg.ExtrReset = 0;
    defparam creg.NumOutputs = 8;
...
module top ;
	...
	wire [0:0] tmpOE__sense_net;
	wire [0:0] tmpFB_0__sense_net;
	wire [0:0] tmpIO_0__sense_net;
	wire [0:0] tmpINTERRUPT_0__sense_net;
	electrical [0:0] tmpSIOVREF__sense_net;
	...
	cy_psoc3_pins_v1_10
		...
		sense
		 (.oe(tmpOE__sense_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sense_net[0:0]}),
		  .analog({Net_143}),
		  .io({tmpIO_0__sense_net[0:0]}),
		  .siovref(tmpSIOVREF__sense_net),
		  .interrupt({tmpINTERRUPT_0__sense_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sense_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__drv_net;
	wire [0:0] tmpFB_0__drv_net;
	wire [0:0] tmpIO_0__drv_net;
	wire [0:0] tmpINTERRUPT_0__drv_net;
	electrical [0:0] tmpSIOVREF__drv_net;
	...
	cy_psoc3_pins_v1_10
		...
		drv
		 (.oe(tmpOE__drv_net),
		  .y({Net_192}),
		  .fb({tmpFB_0__drv_net[0:0]}),
		  .io({tmpIO_0__drv_net[0:0]}),
		  .siovref(tmpSIOVREF__drv_net),
		  .interrupt({tmpINTERRUPT_0__drv_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__drv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__grid1_net;
	wire [0:0] tmpFB_0__grid1_net;
	wire [0:0] tmpIO_0__grid1_net;
	wire [0:0] tmpINTERRUPT_0__grid1_net;
	electrical [0:0] tmpSIOVREF__grid1_net;
	...
	cy_psoc3_pins_v1_10
		...
		grid1
		 (.oe(tmpOE__grid1_net),
		  .y({Net_1369}),
		  .fb({tmpFB_0__grid1_net[0:0]}),
		  .io({tmpIO_0__grid1_net[0:0]}),
		  .siovref(tmpSIOVREF__grid1_net),
		  .interrupt({tmpINTERRUPT_0__grid1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__grid1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__grid2_net;
	wire [0:0] tmpFB_0__grid2_net;
	wire [0:0] tmpIO_0__grid2_net;
	wire [0:0] tmpINTERRUPT_0__grid2_net;
	electrical [0:0] tmpSIOVREF__grid2_net;
	...
	cy_psoc3_pins_v1_10
		...
		grid2
		 (.oe(tmpOE__grid2_net),
		  .y({Net_1463}),
		  .fb({tmpFB_0__grid2_net[0:0]}),
		  .io({tmpIO_0__grid2_net[0:0]}),
		  .siovref(tmpSIOVREF__grid2_net),
		  .interrupt({tmpINTERRUPT_0__grid2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__grid2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__grid3_net;
	wire [0:0] tmpFB_0__grid3_net;
	wire [0:0] tmpIO_0__grid3_net;
	wire [0:0] tmpINTERRUPT_0__grid3_net;
	electrical [0:0] tmpSIOVREF__grid3_net;
	...
	cy_psoc3_pins_v1_10
		...
		grid3
		 (.oe(tmpOE__grid3_net),
		  .y({Net_1464}),
		  .fb({tmpFB_0__grid3_net[0:0]}),
		  .io({tmpIO_0__grid3_net[0:0]}),
		  .siovref(tmpSIOVREF__grid3_net),
		  .interrupt({tmpINTERRUPT_0__grid3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__grid3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__grid4_net;
	wire [0:0] tmpFB_0__grid4_net;
	wire [0:0] tmpIO_0__grid4_net;
	wire [0:0] tmpINTERRUPT_0__grid4_net;
	electrical [0:0] tmpSIOVREF__grid4_net;
	...
	cy_psoc3_pins_v1_10
		...
		grid4
		 (.oe(tmpOE__grid4_net),
		  .y({Net_1465}),
		  .fb({tmpFB_0__grid4_net[0:0]}),
		  .io({tmpIO_0__grid4_net[0:0]}),
		  .siovref(tmpSIOVREF__grid4_net),
		  .interrupt({tmpINTERRUPT_0__grid4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__grid4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("b005d3f8-8b16-46b3-abd7-2a7aa17497e5"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Debouncer_v1_0 mode_deb (
        ...
        .either(Net_1571),
        .pos(Net_1572));
    defparam mode_deb.EitherEdgeDetect = 0;
    defparam mode_deb.NegEdgeDetect = 1;
    defparam mode_deb.PosEdgeDetect = 0;
    defparam mode_deb.SignalWidth = 1;

    Debouncer_v1_0 down_deb (
        .d(Net_1561),
        .clock(Net_1568),
        .q(Net_1563),
        .neg(Net_1564),
        .either(Net_1565),
        .pos(Net_1566));
    defparam down_deb.EitherEdgeDetect = 0;
    defparam down_deb.NegEdgeDetect = 1;
    defparam down_deb.PosEdgeDetect = 0;
    defparam down_deb.SignalWidth = 1;

    Debouncer_v1_0 up_deb (
        .d(Net_1539),
        .clock(Net_1568),
        .q(Net_1541),
        .neg(Net_1536),
        .either(Net_1543),
        .pos(Net_1544));
    defparam up_deb.EitherEdgeDetect = 0;
    defparam up_deb.NegEdgeDetect = 1;
    defparam up_deb.PosEdgeDetect = 0;
    defparam up_deb.SignalWidth = 1;
	...
	cy_clock_v1_0
		#(.id("5696d1a1-13d4-4a58-b931-cee6f99d246b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("31250000000"),
		  .is_direct(0),
