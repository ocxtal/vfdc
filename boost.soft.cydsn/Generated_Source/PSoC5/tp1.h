...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the tp1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(tp1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in tp1_SetInterruptMode() function.
     *  @{
     */
        #define tp1_INTR_NONE      (uint16)(0x0000u)
        #define tp1_INTR_RISING    (uint16)(0x0001u)
        #define tp1_INTR_FALLING   (uint16)(0x0002u)
        #define tp1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define tp1_INTR_MASK      (0x01u) 
#endif /* (tp1__INTSTAT) */
...
/* SIO registers */
#if defined(tp1__SIO_CFG)
    #define tp1_SIO_HYST_EN        (* (reg8 *) tp1__SIO_HYST_EN)
    #define tp1_SIO_REG_HIFREQ     (* (reg8 *) tp1__SIO_REG_HIFREQ)
    #define tp1_SIO_CFG            (* (reg8 *) tp1__SIO_CFG)
    #define tp1_SIO_DIFF           (* (reg8 *) tp1__SIO_DIFF)
#endif /* (tp1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define tp1_0_INTTYPE_REG 		(* (reg8 *) tp1__0__INTTYPE)
#endif /* (tp1__INTSTAT) */
