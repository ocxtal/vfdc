...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000128u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000130u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000148u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AMUX, 0x02u);
